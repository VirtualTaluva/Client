...
namespace VirtualTaluva.Client.Windows.Forms.Game
{
    partial class TableViewerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.logConsole = new VirtualTaluva.Client.Windows.Forms.LogConsole();
            ...
            this.cardPictureBox5 = new VirtualTaluva.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox4 = new VirtualTaluva.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox3 = new VirtualTaluva.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox2 = new VirtualTaluva.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox1 = new VirtualTaluva.Client.Windows.Forms.Game.CardPictureBox();
            this.playerHud10 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud9 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud8 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud7 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud6 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud5 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud4 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud3 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud2 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud1 = new VirtualTaluva.Client.Windows.Forms.Game.PlayerHud();
            ...
            this.btnHelp.Image = global::VirtualTaluva.Client.Windows.Forms.Properties.Resources.help;
            ...
            // pnlTable
            // 
            this.pnlTable.BackgroundImage = global::VirtualTaluva.Client.Windows.Forms.Properties.Resources.table;
